      ...
      <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 p-4" onClick={(e) => e.target === e.currentTarget && onClose()}>
        <div className="bg-white rounded-xl shadow-2xl w-full max-w-5xl max-h-[92vh] flex flex-col">
          ...
          <div className="flex-1 flex overflow-hidden min-h-0">
            ...
            <div className="flex-1 overflow-y-auto px-8 py-6 space-y-5 border-r border-gray-100">
              {/* Title */}
              <input
                type="text"
                value={title}
            ...
            <div className="w-64 xl:w-72 shrink-0 overflow-y-auto px-5 py-6 bg-gray-50/60 space-y-5">
